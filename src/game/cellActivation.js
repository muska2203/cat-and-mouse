import { DIRS_8, inBounds, isWall } from "../nav/pathfinding.js?v=0.4.5-pre-alpha";
import { getItemById, addLootItemToPlayer } from "../loadout.js?v=0.4.5-pre-alpha";
import { rollChestLootItems } from "./chestLoot.js?v=0.4.5-pre-alpha";
import {
  ACTOR_KIND,
  getObjectsAt,
