        ...
        <aside class="cm-col cm-col--left">
          <section class="cm-panel cm-panel--hero" aria-labelledby="hero-title">
            ...
            <div class="cm-panel__body">
              ...
              <div class="cm-bar cm-bar--mana"><div class="cm-bar__row"><span class="cm-bar__icon-wrap"><img class="cm-bar__icon" src="./src/assets/icons/ui/mana.svg" width="22" height="22" alt="" /></span><div class="cm-bar__content"><div class="cm-bar__label"><span>Мана</span><span>${Math.round(Number(displaySheet?.mana || 0))} / ${Math.round(Number(displaySheet?.manaMax || 1))}</span></div><div class="cm-bar__track"><div class="cm-bar__fill" style="width:${Math.max(0, Math.min(100, Math.round((Math.round(Number(displaySheet?.mana || 0)) / Math.max(1, Math.round(Number(displaySheet?.manaMax || 1)))) * 100)))}%"></div></div></div></div></div>
