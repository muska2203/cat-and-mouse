import { createHoverPopoverController } from "./hoverPopover.js?v=0.5.8-pre-alpha";
import { buildWorldObjectDetailHtml, pickPriorityWorldObject } from "./worldObjectHover.js?v=0.5.8-pre-alpha";
