import { getSkillManaCost } from "../skillsRuntime.js?v=0.5.4-pre-alpha";
import { buildItemSpriteStackHtml, buildSkillSpriteHtml } from "./spriteIconHtml.js?v=0.5.4-pre-alpha";
