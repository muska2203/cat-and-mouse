import { buildSkillHoverData } from "../skillsRuntime.js?v=0.5.2-pre-alpha";
import { getSkillManaCost } from "../skillsRuntime.js?v=0.5.2-pre-alpha";
import { buildSkillSpriteHtml } from "./spriteIconHtml.js?v=0.5.2-pre-alpha";
import { buildHoverCardHtml, escapeHtml } from "./hoverCardHtml.js?v=0.5.2-pre-alpha";
