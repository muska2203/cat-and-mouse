import { buildDerivedStats, floorHp, floorHpMax, roundStat } from "./rules.js?v=0.4.6-pre-alpha";
import { attachConsumableApplyToItems } from "./items/consumableApply.js?v=0.4.6-pre-alpha";
