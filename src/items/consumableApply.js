...
import { getConsumableApplyLog } from "./itemPresentation.js?v=0.4.4-pre-alpha";
import { removeObject } from "../game/cellObjects.js?v=0.4.4-pre-alpha";
import { getXpForEnemy, applyXpGain } from "../game/xp.js?v=0.4.4-pre-alpha";
import { findNearestEnemy } from "../game/enemies.js?v=0.4.4-pre-alpha";
import { syncPlayerHp } from "../game/syncHp.js?v=0.4.4-pre-alpha";
