import { floorHp, floorHpMax } from "../rules.js?v=0.5.2-pre-alpha";
import { getConsumableApplyLog, getConsumableRecoveryPreview } from "./itemPresentation.js?v=0.5.2-pre-alpha";
