import { floorHp, floorHpMax } from "../rules.js?v=0.4.13-pre-alpha";
import { getConsumableApplyLog, getConsumableRecoveryPreview } from "./itemPresentation.js?v=0.4.13-pre-alpha";
