 ...
 */
import { localizeStatText } from "../strings/ru.js?v=0.5.1-pre-alpha";
...
const HOVER_BY_ID = {
  ...
  rare_trap_poison_cloud:
    "установка в соседнюю свободную клетку. При срабатывании: 4 урона, оглушение на 2 хода и ядовитый туман на клетке и вокруг (3x3).",
